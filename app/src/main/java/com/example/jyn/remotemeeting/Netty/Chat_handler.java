...
public class Chat_handler extends ChannelInboundHandlerAdapter {
    ...
    /**---------------------------------------------------------------------------
     메소드 ==> otto -- to RCV_chatRoom_list_adapter
                    : Data_for_netty 객체와 함께 채팅방 리사이클러뷰에 대한 변경점 이벤트 메시지를 전달
     ---------------------------------------------------------------------------*/
    public void to_RCV_chatRoom_list_adapter(String message, Data_for_netty data) {
        // otto 등록
        ...
        Log.d(TAG, "otto 전달_ to_RCV_chatRoom_list_adapter");
    ...
    public void channelRead(ChannelHandlerContext ctx, Object obj) throws Exception {
        ...
        switch (data.getType()) {
            ...
            case "msg":
                ...
                to_RCV_chatRoom_list_adapter("update", data);
