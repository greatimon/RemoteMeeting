...
import com.example.jyn.remotemeeting.WebRTC.AppRTCClient.SignalingParameters;
 ...
 * AppRTC 룸 URL을 해당 방에서 사용할 신호 매개 변수 세트로 변환하는 AsyncTask.
 */
public class RoomParametersFetcher {
    ...
    // 요청 URL을 기반으로 TURN ICE 서버를 요청하고 반환합니다. 메인 스레드에서 실행해야합니다!
    ...
    // WebRTCPeerConnection 구성 문자열에 의해 설명 된 ICE 서버 목록을 반환합니다.
    ...
    // InputStream의 내용을 String로서 돌려줍니다.
