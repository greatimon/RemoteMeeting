...
public class Notice_F extends Fragment {
    ...
    private static final String TAG = "all_"+Notice_F.class.getSimpleName();
    ...
    public static Notice_F newInstance() {
        Bundle args = new Bundle();

        Notice_F fragment = new Notice_F();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // 프래그먼트 인플레이팅
        layout = (SwipeRefreshLayout) inflater.inflate(R.layout.f_notice, container, false);
