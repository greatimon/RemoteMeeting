package com.example.jyn.remotemeeting.Etc;
...
public class Static {
    ...
    public static String SERVER_URL_MEETING_UPLOAD_FILE = "http://115.71.232.211/meeting_upload_file/";
    ...
    public static String GET_USER_INFO = "get_user_info.php";
    public static String UPLOAD_PROFILE_IMG = "upload_profile_img.php";
